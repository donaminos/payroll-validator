...
export function AddEmployeeDrawer() {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-full max-w-[600px] px-0 sm:max-w-[600px] bg-[#f8fafc] border-l flex flex-col">
        <div className="px-8 pt-8 pb-2">
          <SheetHeader>
            <SheetTitle className="text-3xl font-semibold tracking-tight text-gray-900">Ajouter un employé</SheetTitle>
          </SheetHeader>
        </div>
        <form className="flex-1 overflow-y-auto px-8 py-6 flex flex-col gap-0 bg-[#f8fafc]">
          <div className="divide-y divide-gray-200 border rounded-xl bg-white">
            ...
            <FormRow label="Date d'embauche" htmlFor="hireDate">
              <Input id="hireDate" name="hireDate" type="date" required className="bg-white" />
            </FormRow>

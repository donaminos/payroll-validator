 ...
 */
const FIRST_NAMES = [
  'Jean', 'Pierre', 'Michel', 'André', 'Philippe', 'Claude', 'Jacques', 'François', 'Daniel', 'Robert',
  'Marie', 'Sophie', 'Isabelle', 'Nathalie', 'Catherine', 'Françoise', 'Monique', 'Christine', 'Martine', 'Brigitte',
  'Thomas', 'Nicolas', 'David', 'Christophe', 'Stéphane', 'Laurent', 'Eric', 'Olivier', 'Sébastien', 'Vincent',
  'Julie', 'Céline', 'Sandrine', 'Valérie', 'Caroline', 'Aurélie', 'Delphine', 'Émilie', 'Audrey', 'Stéphanie',
  'Alexandre', 'Romain', 'Guillaume', 'Antoine', 'Maxime', 'Baptiste', 'Hugo', 'Lucas', 'Paul', 'Arthur',
  'Camille', 'Léa', 'Emma', 'Chloé', 'Manon', 'Sarah', 'Laura', 'Clara', 'Jade', 'Louise',
  'Louis', 'Jules', 'Gabriel', 'Raphaël', 'Léo', 'Adam', 'Hector', 'Victor', 'Antonin', 'Théo',
  'Alice', 'Inès', 'Eva', 'Zoé', 'Agathe', 'Lola', 'Nina', 'Mia', 'Léna', 'Eden',
  'Ethan', 'Noah', 'Liam', 'Mason', 'William', 'James', 'Benjamin', 'Lucas', 'Henry', 'Alexander'
] as const;
...
const LAST_NAMES = [
  ...
  'Carre', 'Leclerc', 'Colin', 'Vidal', 'Caron', 'Picard', 'Gaillard', 'Philippe', 'Leroux', 'Giraud',
  'Bonnet', 'Schmitt', 'Lemoine', 'Riviere', 'Lucas', 'Brun', 'Gauthier', 'Barbier', 'Arnaud', 'Dumas'
] as const;
 ...
 */
const STREETS = [
  'Rue de la Paix', 'Avenue des Champs-Élysées', 'Boulevard Saint-Germain', 'Rue de Rivoli', 'Avenue Montaigne',
  'Rue du Faubourg Saint-Honoré', 'Boulevard Haussmann', 'Rue de la Bourse', 'Avenue de l\'Opéra', 'Rue Saint-Denis',
  'Boulevard de la Madeleine', 'Rue de la Pompe', 'Avenue Victor Hugo', 'Rue de Passy', 'Boulevard Malesherbes',
  'Rue de Sèvres', 'Avenue des Ternes', 'Boulevard de Courcelles', 'Rue de Rome', 'Avenue de Wagram',
  'Rue de la Fayette', 'Boulevard de Magenta', 'Avenue de la République', 'Rue du Temple', 'Boulevard du Temple',
  'Rue de Bretagne', 'Avenue Parmentier', 'Boulevard de Belleville', 'Rue de Belleville', 'Avenue Gambetta',
  'Rue des Pyrénées', 'Boulevard de Charonne', 'Avenue de la Porte de Montreuil', 'Rue de Bagnolet', 'Boulevard de la Villette'
] as const;
...
export function generateEmployees(): Employee[] {
  ...
  for (let i = 1; i <= 1000; i++) {
    ...
    const contractType = ['CDI', 'CDD', 'Interim', 'Stage'][Math.floor(Math.random() * 4)] as Employee['contractType'];
    ...
    const employee: Employee = {
      ...
      managerId: i > 50 ? `emp_${Math.floor(Math.random() * 50) + 1}` : undefined,
      ...
      emergencyContact: {
        ...
        relationship: ['Conjoint', 'Parent', 'Enfant', 'Ami'][Math.floor(Math.random() * 4)],
        phone: generatePhoneNumber()
      },
